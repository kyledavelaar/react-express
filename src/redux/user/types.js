...
export const API_CALL_REQUEST = "USER_API_CALL_REQUEST";
export const API_CALL_SUCCESS = "USER_API_CALL_SUCCESS";
export const API_CALL_FAILURE = "USER_API_CALL_FAILURE";